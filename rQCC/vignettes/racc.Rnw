...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Robust $g$-type attributes control charts (\texttt{racc})
...
\maketitle
\begin{abstract}
The $g$-type attributes control charts based on the geometric distribution are widely
...
However, conventional $g$-type charts are based on the maximum likelihood
...
In this note, we provide a brief summary of robust $g$-type attributes control charts
...
\end{equation}
However, it is shown to be biased. For more details, see \cite{Park/Wang:2022}.
...
%----------------------------------------------------------------------------------------------------------
For more details on the conventional $g$-type attributes control charts based on the above estimators,
...
%======================================
\section{Construction of the $g$-type quality control charts} \label{Section:03}
%======================================
...
we can obtain the $g$-type robust control limits by plugging $\hat{p}$
